      ...
      try {
        ...
        if (ratings.length === 0) {
          ...
          return {
            embeds: [
              getErrorEmbed({
                error: `No ratings found for [**${username}**](https://rateyourmusic.com/collection/${username}). If you changed your username, you'll need to updated it with \`/set username\``,
              }),
            ],
            private: true,
          }
